...
def start_main_page():
    ...
    def option():
        ...
        sel_btn1 = Button(
            ...
            bg="#99ffd6",                               #background color
            cursor="hand2",
            command=lambda: start_game(1),               #fun to be called when button clicked
        )
    ...
    def show_option():
        start_btn.destroy()                             #remove start button from window

        lab_img.destroy()                               #remove icon from window
        option()                                        #display categoried for quiz
